...
/***/ function(module, exports, __webpack_require__) {
	...
	var _yieldsKeycode = __webpack_require__(165);
	
	var _yieldsKeycode2 = _interopRequireDefault(_yieldsKeycode);
	
	var _randomcolor = __webpack_require__(163);
	...
	var App = _react2.default.createClass({
	  ...
	  handleKeyPress: function handleKeyPress(e) {
	    if (e.which === (0, _yieldsKeycode2.default)('enter')) {
	      e.preventDefault();
	      this.setState({
	        current: '',
	        messages: this.state.messages.concat({
	          ...
	          y: Math.random() * 100,
	          color: (0, _randomcolor2.default)({ luminosity: 'light' })
	        })
	      });
	    }
	  },
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      'div',
	      { className: 'view-playground-danmu' },
	      _react2.default.createElement(_src2.default, { width: 640, height: 480, messages: messages }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Message = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    var screen = _props.screen;
	    var y = _props.y;
	    var size = _props.size;
	    var color = _props.color;
	    var status = this.state.status;
	
	    var fontSize = DEFAULT_FONT_SIZE * size;
	    ...
	    return _react2.default.createElement(
	      'div',
	      { className: (0, _classname2.default)('danmu-message', status.toLowerCase()), style: style },
	      content
	    );
	  }
	});
	
	var Danmu = _react2.default.createClass({
	  displayName: 'Danmu',
	  ...
	  render: function render() {
	    ...
	    var messages = this.props.messages.concat(this.state.messages);
	    var screen = {
	      width: width,
	      height: height
	    };
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'danmu-screen', style: screen },
	        messages.map(function (message, index) {
	          return _react2.default.createElement(Message, _extends({ key: index }, { screen: screen }, message));
	        })
	      )
	    );
	  }
